function [P,f,alpha,z] = lomb(x,t,varargin)
...
a = [0.001 0.01 0.05 0.5];%[0.005  0.1]
z = -log(1-(1-a).^(1/M));
...
if fig
    ...
    hold on;
    for i=1:La
        line([f(1),0.84*f(end)],[z(i),z(i)],'Color','k','LineStyle',styles{ceil(i*3/La)});
        text(1*f(end),z(i),strcat('\alpha = ',num2str(a(i))),'fontsize',16); 
